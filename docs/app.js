...
const SOLO_EPISODES = [
  // 第1話は 6コマ漫画（scene_1_1〜1_6）。「つぎへ」で 1コマずつ 進む＝アニメのように 見える
  { id: "ep1", n: "第1話", t: "出会い", lv: 0, scene: 1, lines: [
    { who: "", scene: "1_1", text: "ある日、そろばんの 練習道具を 持って、森の 近くに やってきた。" },
    { who: "", scene: "1_2", text: "森の おくで、見たことのない 小さな 生きものを 見つけた。" },
    { who: "きみ", scene: "1_3", text: "ゆうきを 出して、声を かけてみた。「きみも そろばん やるの？」——「やる！」" },
    { who: "ソロモン", scene: "1_4", text: "「これは そろばんだよ。数で 世界を ひらく 道具なんだ。」「すごい！ ぼくも いっしょに やりたい！」" },
    { who: "", scene: "1_5", text: "こうして、ふたりの そろばんの 練習が はじまった。カチッ、カチッ。" },
    { who: "", scene: "1_6", text: "こうして、ぼくと ソロモンの ぼうけんの はじまりが 動き出した——　ここから、ぼくらの ものがたりが はじまる。" } ] },
